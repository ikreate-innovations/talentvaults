          ...
          <div className="bg-card-light dark:bg-card-dark rounded-xl p-8 border border-border-light dark:border-border-dark text-center">
            ...
            <div className="mt-4">
              <p className="text-[10px] italic text-text-muted-light dark:text-gray-400 text-center">
                *Affiliate notice: This button takes you to the {tool.website_name} website, which uses cookies for tracking to attribute referrals. TalentVaults earns a commission if you sign up and purchase this service or product. For more information, see our privacy policy. *Affiliate-Hinweis: Diese Schaltfläche führt Sie zur Webseite von {tool.website_name}, wo Cookies für Tracking zur Zuordnung von Empfehlungen verwendet werden. TalentVaults erhält eine Provision, wenn Sie sich anmelden und dieses Produkt oder diese Dienstleistung erwerben. Weitere Informationen finden Sie in unserer Datenschutzerklärung.
              </p>
            </div>
          </div>
        </div>
